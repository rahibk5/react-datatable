...
const SearchIcon = (props) => (jsxRuntimeExports.jsxs("svg", Object.assign({ "aria-hidden": "true", fill: "none", focusable: "false", height: "1em", role: "presentation", viewBox: "0 0 24 24", width: "1em" }, props, { children: [jsxRuntimeExports.jsx("path", { d: "M11.5 21C16.7467 21 21 16.7467 21 11.5C21 6.25329 16.7467 2 11.5 2C6.25329 2 2 6.25329 2 11.5C2 16.7467 6.25329 21 11.5 21Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2" }), jsxRuntimeExports.jsx("path", { d: "M22 22L20 20", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2" })] })));
...
function App({ columns, data, filterOptions, searchable, customClass }) {
    ...
    const paginatedItems = React.useMemo(() => {
        ...
        return filteredAndSortedItems.slice(start, end).map((item, index) => (Object.assign(Object.assign({}, item), { index: start + index + 1 })));
    ...
    const renderDropdowns = React.useMemo(() => {
        return processedFilterOptions === null || processedFilterOptions === void 0 ? void 0 : processedFilterOptions.map((filter) => (filter.searchable ? (jsxRuntimeExports.jsx("div", { className: "f-search-container", children: jsxRuntimeExports.jsx(react.Autocomplete, { label: filter.name, className: "min-w-min rounded px-3 py-2", children: filteredOptions(filter).map((option) => (jsxRuntimeExports.jsx(react.AutocompleteItem, { value: option.uid, className: "bg-white dark:bg-[#122031] rounded shadow", children: option.name }, option.uid))) }) })) :
            (jsxRuntimeExports.jsx("div", { className: "f-dropdown-container", children: jsxRuntimeExports.jsxs(react.Dropdown, { children: [jsxRuntimeExports.jsx(react.DropdownTrigger, { className: "hidden sm:flex", children: jsxRuntimeExports.jsx(react.Button, { endContent: jsxRuntimeExports.jsx(ChevronDownIcon, { className: "text-small" }), size: "sm", variant: "flat", className: "min-w-min rounded px-3 py-2", children: filter.name }) }), jsxRuntimeExports.jsxs(react.DropdownMenu, { disallowEmptySelection: false, "aria-label": "Table Columns", closeOnSelect: false, selectedKeys: filters[filter.uid] || new Set(), selectionMode: (filter === null || filter === void 0 ? void 0 : filter.selectMode) || "single", onSelectionChange: (selection) => updateFilter(filter.uid, selection), className: "bg-white dark:bg-[#122031] rounded shadow", children: [filter.searchable && (jsxRuntimeExports.jsx(react.DropdownItem, { className: "p-2", children: jsxRuntimeExports.jsx(react.Input, { isClearable: true, placeholder: `Search ${filter.name}...`, size: "sm", value: filterSearch[filter.uid] || "", onClear: () => setFilterSearch(Object.assign(Object.assign({}, filterSearch), { [filter.uid]: "" })), onValueChange: (value) => setFilterSearch(Object.assign(Object.assign({}, filterSearch), { [filter.uid]: value })) }) }, "search")), filteredOptions(filter).map((option) => (jsxRuntimeExports.jsx(react.DropdownItem, { className: "capitalize", children: capitalize(option.name) }, option.uid)))] })] }, filter.uid) }))));
