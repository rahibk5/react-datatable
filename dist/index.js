...
function App({ columns, data, filterOptions, searchable, customClass }) {
    ...
    const renderDropdowns = React.useMemo(() => {
        return processedFilterOptions === null || processedFilterOptions === void 0 ? void 0 : processedFilterOptions.map((filter) => (filter.searchable ? (jsxRuntimeExports.jsx("div", { className: "f-search-container", children: jsxRuntimeExports.jsx(react.Autocomplete, { label: "", placeholder: filter.name, className: "min-w-min rounded px-3 py-2 bg-white dark:bg-[#122031] ", children: filteredOptions(filter).map((option) => (jsxRuntimeExports.jsx(react.AutocompleteItem, { value: option.uid, className: "bg-white dark:bg-[#122031]", children: option.name }, option.uid))) }, filter.uid) })) :
